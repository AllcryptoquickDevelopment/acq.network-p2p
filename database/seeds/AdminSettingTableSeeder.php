...
class AdminSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AdminSetting::firstOrCreate(['slug' => 'mail_username'], ['value' => 'test']);
        AdminSetting::firstOrCreate(['slug' => 'mail_password'], ['value' => 'test']);
        AdminSetting::firstOrCreate(['slug' => 'mail_encryption'], ['value' => 'null']);
        AdminSetting::firstOrCreate(['slug' => 'mail_from_address'], ['value' => 'test']);
        ...
        AdminSetting::firstOrCreate(['slug' => 'chain_id'], ['value' => "97"]);
        AdminSetting::firstOrCreate(['slug' => 'chain_link'], ['value' => "https://data-seed-prebsc-1-s1.binance.org:8545"]);
        AdminSetting::firstOrCreate(['slug' => 'contract_address'], ['value' => "test"]);
        AdminSetting::firstOrCreate(['slug' => 'wallet_address'], ['value' => "test"]);
        AdminSetting::firstOrCreate(['slug' => 'private_key'], ['value' => "test"]);
